...
yp = diff_center ( 'fun(x)', x, h );
 ...
 legend ( 'True derivative', 'Forward difference','Centered difference' )
  grid ( 'on' );
  hold ( 'on' )
...
%% vector_to_element rewrites a MATLAB vector function elementwise.
%
%  Discussion:
%
